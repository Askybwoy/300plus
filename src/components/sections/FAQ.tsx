...
const faqs = [
  ...
  {
    question: "Почему именно 14\u00A0дней? Не\u00A0будет\u00A0ли\u00A0это\u00A0в\u00A0ущерб качеству?",
    answer:
      "14 дней — это оптимальный срок для тестирования гипотезы. Мы фокусируемся на ключевых элементах: конверсионный лендинг, узнаваемый бренд и настроенная реклама. Всё остальное можно доработать после получения первых результатов.",
  },
  {
    question: "Что\u00A0входит в\u00A0пакет СТАРТ за 15 000\u00A0₽?",
    answer:
      "Пакет СТАРТ включает глубокий аудит вашего текущего сайта с PDF-отчётом, содержащим 5 проверенных гипотез для роста конверсии, UX-разбор главной страницы с макетом главного экрана, а также список из 10 конкретных действий с приоритетами. Идеально, если у вас есть сайт, но вы не понимаете, почему нет заявок.",
  },
  {
    question: "Чем отличается СПРИНТ от ПОЛНОГО ЗАПУСКА?",
    answer:
      "СПРИНТ (90 000 ₽, 7 дней) — это обновление главной страницы: новый дизайн, вёрстка, подключение аналитики и A/B-тест заголовков. ПОЛНЫЙ ЗАПУСК (300 000 ₽, 14 дней) — комплексное решение: фирменный стиль, полный лендинг, запуск рекламы и 30 дней поддержки. Выбирайте СПРИНТ для быстрого результата, ПОЛНЫЙ ЗАПУСК — для запуска с нуля.",
  },
  {
