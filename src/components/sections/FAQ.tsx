...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Пакет СТАРТ включает глубокий аудит вашего текущего сайта с PDF-отчётом, содержащим 5 проверенных гипотез для роста конверсии, UX-разбор главной страницы с макетом правок, а также список из 10 конкретных действий с приоритетами. Идеально, если у вас есть сайт, но вы не понимаете, почему нет заявок.",
  },
  {
